...
__global__ void myFirstKernel(int *d_a, size_t memSize)
{
...
int main(int argc, char** argv)
{
    ...
    cudaMalloc(reinterpret_cast<void**>(&d_a), memSize);

    // Part 2 of 5: configure and launch kernel with 1d grid and 1d thread block
